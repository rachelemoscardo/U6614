...
#5d.
  ...
  # save(list = "arrests.clean", file = "../myfoldername/arrests.clean.RData")
  ...
  # save(list = c("arrests.clean", "arrests_bds.clean", "arrests_las.clean"),
  #                file = "arrests_morestuff.RData")
  #?save

  #for future reference you can also write single dataframes to a csv file:
  #write_csv(arrests.clean, "arrests.clean.csv") 
