...
- Neil Ke-Jian Chin (morning section)
- Tirtha Patel (afternoon section)
...
- This is my 8th year teaching quant courses at SIPA.
...
- If you are feeling unwell or facing unexpected challenges outside of school, please email me right away to briefly explain your situation and request a Zoom link for class if necessary. 
- Whenever feasible, Zoom links and/or recordings will be provided for students with excused absences. We will try to record at least one of the two weekly class meetings (and recitations)--not necessarily both--so you will either have the opportunity to attend remotely in real-time, or view the recording after.
