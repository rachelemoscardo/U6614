...
# Aggregating tosubway station-level arrest totals
...
##  Import and inspect poverty and ridership data files (*station_povdataclean_2016.csv* and *Subway Ridership by Station - BK.csv*).
...
##  Print the top 10 stations by total arrest counts
...
## Compute arrest intensity and other explanatory variables for analysis.
  ...
  - *Create new column of data for the following:*
    ...
    + *a dummy for majority Black station areas: nblack = 1 if shareblack > .5*
...
## Estimate and test difference in mean arrest intensity between high/low poverty areas
