...
##### *Please submit your knitted .pdf file along with the corresponding R markdown (.rmd) via Courseworks by 11:59pm on Friday, October 15 (extension until Saturday, October 16).* {-}
...
arrests_all <- read.csv("arrests_all.csv", 
                        ...
                        na.strings = c("")) 
#can specify string values to read in as NA (here blanks)
```
