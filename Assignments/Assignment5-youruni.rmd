...
## Plot and interpret the shutoff race over time for tracts below/above citywide median housheold income (show two time series on a single plot).

## Plot and interpret the shutoff race over time for tracts that are at least 75% Black and those that aren't (show two time series on a single plot).
