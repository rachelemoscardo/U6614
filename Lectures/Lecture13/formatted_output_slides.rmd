...
Descriptive time series plots by groups are often a good way to motivate your analysis.


## Tips for your presentation {.build}

<div>
- Remember to do all of your work in R script(s) and only load the objects you need into your .rmd file (use .RData and .rds files and call `load`)
</div>
...
<div>
- Don't forget to spellcheck and review your knit document!
</div> 
