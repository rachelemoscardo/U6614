...
outreg2 using "$output/figureA2C10_asmr_w.xls", `r' keep(HC_Texp_2-HC_Texp_27) noparen noaster ctitle("dmr")
local r append

xi: reg lnnmr1 `X' [aw=births] if white, cluster(stfips)
outreg2 using "$output/figureA2C10_asmr_w.xls", `r' keep(HC_Texp_2-HC_Texp_27) noparen noaster ctitle("nmrx")

xi: reg lnpnmr `X' [aw=births] if white, cluster(stfips)
outreg2 using "$output/figureA2C10_asmr_w.xls", `r' keep(HC_Texp_2-HC_Texp_27) noparen noaster ctitle("pnmr")

xi: reg lnasmr14 `X' [aw=pop14] if white, cluster(stfips)
outreg2 using "$output/figureA2C10_asmr_w.xls", `r' keep(HC_Texp_2-HC_Texp_27) noparen noaster ctitle("asmr14")

xi: reg lnasmr59 `X' [aw=pop59] if white, cluster(stfips)
outreg2 using "$output/figureA2C10_asmr_w.xls", `r' keep(HC_Texp_2-HC_Texp_27) noparen noaster ctitle("asmr59")

xi: reg lnasmr1014 `X' [aw=pop1014] if white, cluster(stfips)
outreg2 using "$output/figureA2C10_asmr_w.xls", `r' keep(HC_Texp_2-HC_Texp_27) noparen noaster ctitle("asmr1014")
