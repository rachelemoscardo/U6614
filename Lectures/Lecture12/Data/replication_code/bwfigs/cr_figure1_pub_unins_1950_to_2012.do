...
scatter unins_nhis 	unins_guess_shsue ///
	...
	c(l n l l l l) cmissing(n n n n n n n n) msymbol(O x i Sh Th) msize(medium large medium medium medium) mcolor(black black gray gray gray) ///
	lpattern(solid solid solid solid dash) lwidth(medium medium medium medium medium) lcolor(black black gray gray gray) ///
