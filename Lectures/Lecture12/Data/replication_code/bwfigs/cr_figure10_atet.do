...
(scatter ord ci 	if ord==4, c(l) msymbol(+) mcolor(black) msize(large) lcolor(black) text(4.25 `m4' "`m4'%") ) ///
(scatter ord atet 	if ord==4, c(l) msymbol(O) mcolor(black) msize(medium) lcolor(black) text(4 100 "`p4'" "`p41'", size(small))) ///
(scatter ord ci 	if ord==5, c(l) msymbol(+) mcolor(black) msize(large) lcolor(black) text(5.25 `m5' "`m5'%") ) ///
(scatter ord atet 	if ord==5, c(l) msymbol(O) mcolor(black) msize(medium) lcolor(black) text(5 100 "`p5'" "`p51'", size(small))) ///
(scatter ord ci 	if ord==6, c(l) msymbol(+) mcolor(black) msize(large) lcolor(black) text(6.25 `m6' "`m6'%") ) ///
(scatter ord atet 	if ord==6, c(l) msymbol(O) mcolor(black) msize(medium) lcolor(black) text(6 100 "`p6'" "`p61'", size(small)) ///
