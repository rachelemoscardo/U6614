...
### Liam Tay Kearney, Teaching Assistant
...
2. Show the data structure of the gapminder dataframe in the gapminder package.
3. What is the average gdpPercap across all observations in the dataset?
