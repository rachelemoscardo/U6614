...
\CommentTok{\#\textgreater{} [1] "C:/Users/hstol/Google Drive/SIPA/R {-} Data Analysis/U6614/Lectures/Lecture1"}
\end{Highlighting}
\end{Shaded}
...
\item
  ...
  \tightlist
  \item
    \emph{Cmd/Ctrl + Enter}: execute highlighted line(s) within chunk
  \item
    \emph{Cmd/Ctrl + Shift + k}: ``knit'' entire document
  \end{itemize}
...
\item
  ...
  \end{itemize}
\item
  4 weekly assignments (``data memos'')
\item
