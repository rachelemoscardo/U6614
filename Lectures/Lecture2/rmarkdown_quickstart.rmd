...
Piping a dataframe to knitr::kable() makes it look nicer in R Markdown.
```{r}
gapminder %>% 
  head(5) %>% 
  knitr::kable()
...
And the reverse, display the code without evaluating (i.e. no results)
...
Or, execute code and not display anything (neither code nor results)
...
Remember, you can execute code in R Markdown without knitting, just like in a .r script. 
