...
Cross-sections of data can be combined into a single dataset, but that is different from **panel data** where the *same indidividuals* or entities are observed in each period.
