...
Identity is deeply personal, and so are the labels people use. The Census asks people if they identify as "Hispanic, Latino, or Spanish origin." Some unknown share of younger, progressive Americans who would say they identify as Hispanic might prefer to identify as Latinx or Latine, for example. When presenting your own analysis of raw data that uses gendered race and ethnicity labels with colonial roots, should you replace them with more progressive, gender-neutral labels? 
...
Please post a reply to the relevant Piazza post by Monday before class. Include your responses to one or both of the below questions, and/or any additional aspects about categorizing/coding identity that you wish to comment on. 
