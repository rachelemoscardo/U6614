...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Pre-class lecture content}, i.e.~lessons and/or videos
  students are expected to work through independently in advance of
  class in order to prepare for in-class discussion and application
  using R. Many of these lessons will introduce different aspects of R
  functionality and syntax. Others will focus on real-world examples of
  data issues and methodological applications, and may include short
  readings. Each class will begin with a short Zoom quiz on this content
  to encourage engagement in advance of class. This will be followed by
  some in-class time for discussion to engage with the material, often
  using Zoom breakout rooms and Poll Everywhere. Pre-class lecture
  content for Tuesday's class session will be posted by the previous
  Thursday.
\item
...
\hypertarget{week-4-9292020-joins-data-structure-research-design-inference-regression}{%
\subsection{Week 4, 9/29/2020: Joins, Data Structure \& Research Design,
Inference \&
Regression}\label{week-4-9292020-joins-data-structure-research-design-inference-regression}}
...
\hypertarget{week-5-1062020-survey-data-weighting-exploratory-data-analysis-tools}{%
\subsection{Week 5, 10/6/2020: Survey Data, Weighting, Exploratory Data
Analysis
Tools}\label{week-5-1062020-survey-data-weighting-exploratory-data-analysis-tools}}
