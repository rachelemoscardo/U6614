...
\hypertarget{zoom-quizes-and-in-class-participation-10}{%
\subsection{Zoom Quizes and In-class Participation
(10\%)}\label{zoom-quizes-and-in-class-participation-10}}
...
account for 5\% of your total grade, all other participation 5\%. This
component can make the difference between an A and B for your overall
course grade, for example, so please come to class prepared and ready to
participate.

\hypertarget{attendance}{%
\subsection{Attendance}\label{attendance}}

Attending synchronous class sessions is required. Multiple unexcused
absences may result in additional deductions to your overall course
