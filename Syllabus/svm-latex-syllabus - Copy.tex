...
Harold Stolper & Class Hours: $if(classhours)$$classhours$$else$TBD$endif$\\
Lecturer in Discipline & Classroom: $if(classroom)$$classroom$$else$TBD$endif$\\
E-mail: $if(email)$\texttt{$email$}$else$TBD$endif$ & Recitation Hours: $if(recitationhours)$$recitationhours$$else$TBD$endif$\\
Office Hours: $if(officehours)$$officehours$$else$TBD$endif$  &  Recitation Room: $if(recitationroom)$$recitationroom$$else$TBD$endif$\\
	&  \\
	\hline
	\end{tabular*}
