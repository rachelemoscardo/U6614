...
#office: "TBD"
officehours: Group/walk-in Tues 5:30-6:30pm | [book](https://helloharold.youcanbook.me) indiv. appt.

#web: 
classmeetings: "Tues 2:10-4pm, online"
recitation: "Thurs 6:10-8pm, hybrid"
#recitationroom: "Hybrid (online/IAB 501a)"
...
1. **Pre-class lecture content**, i.e. lessons and/or videos students are expected to work through independently in advance of class in order to prepare for in-class discussion and application using R. Many of these lessons will introduce different aspects of R functionality and syntax. Others will focus on real-world examples of data issues and methodological applications, and may include short readings. Each class will begin with a short Zoom quiz on this content to encourage engagement in advance of class. This will be followed by some in-class time for discussion to engage with the material, often using Zoom breakout rooms and Poll Everywhere. Pre-class lecture content for Tuesday's class session will be posted by the previous Thursday.
...
- In-class data: Brooklyn subway fare evasion arrest data
- _Assignment 4 posted after class: due by midnight on Monday, 10/5/2020_
\medskip


## Week 5, 10/6/2020: Survey Data, Weighting, Exploratory Data Analysis Tools
...
- _Project deliverable #2: Mini-proposal with summary statistics due by midnight on 10/30._
\medskip
