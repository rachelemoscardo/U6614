...
Describe data sources, representative population, and any other context the reader should know about the data as it pertains to the analysis you do. More details can be included in a data appendix - see [here](https://www.cssny.org/pages/false-narrative-data) for an example.
...
You can also add notes for more documentation of technical details.
